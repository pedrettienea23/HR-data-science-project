...
attrition_clf = joblib.load(os.path.join(model_path, 'attrition_model.pkl'))
performance_clf = joblib.load(os.path.join(model_path, 'performance_driver_analysis.pkl'))
```
...
df['Comp_Ratio'] = df['Salary'] / df.groupby('Position')['Salary'].transform('mean')
df['Engage_Perf_Gap'] = (df['PerfScoreID'] / 4) - (df['EngagementSurvey'] / 5)
...
y_perf = df['PerformanceScore'].isin(['Fully Meets', 'Exceeds']).astype(int)
...
```
    ...
    86 employees may leave.
                   Employee_Name                  Position  Attrition_Risk_%  \
    4           Anderson, Carol    Production Technician I             100.0   
    93   Fitzpatrick, Michael  J  Production Technician II              97.0   
    24           Bondwell, Betsy  Production Technician II              96.0   
    136              Huynh, Ming  Production Technician II              96.0   
    15             Bates, Norman   Production Technician I              95.0   
    65           DeGweck,  James   Production Technician I              94.0   
    163            Leach, Dallas   Production Technician I              94.0   
    229           Rarrick, Quinn   Production Technician I              94.0   
    168        Linares, Marilyn    Production Technician I              93.0   
    119             Gross, Paula   Production Technician I              93.0   
...
```
              ...
              Employee_Name                  Position  Attrition_Risk_%  \
    46     Chivukula, Enola   Production Technician I              70.0   
    147     Kampew, Donysha             Sales Manager              70.0   
    285        True, Edward         Software Engineer              69.0   
    14        Barton, Nader   Production Technician I              69.0   
    18        Becker, Renee    Database Administrator              68.0   
    199         Ndzi, Horia   Production Technician I              67.0   
    265  Squatrito, Kristen   Production Technician I              67.0   
    104     Gill, Whitney          Area Sales Manager              66.0   
    304  Winthrop, Jordan    Production Technician II              65.0   
    213    Pearson, Randall              Data Analyst              63.0   
